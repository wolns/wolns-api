...
class UserController(Controller):
    ...
    @post("/me")
    async def get_me(self, user: UserModel) -> IUserBase: ...

    @get("/{id:uuid}")
    async def get_by_id(self, id: UUID, user: UserModel) -> IUserRead: ...

    @post("/{id:uuid}/follow")
    async def follow(self, id: UUID, user: UserModel) -> None: ...

    @delete("/{id:uuid}/follow")
    async def unfollow(self, id: UUID, user: UserModel) -> None: ...

    @get("/{id:uuid}/singers/stats")
    async def get_singers_stats(self, id: UUID, user: UserModel) -> IUserRead: ...
